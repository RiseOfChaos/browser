...
class Tile {
  ...
  String get color => colors.values.elementAt(x);
...
class CityMapComponent {
  ...
  clicked(MouseEvent event) {
    print("${event.offset} ${divPoint(event.offset, 64)}");
  }
}

Point<int> divPoint(Point<num> inp, int div) =>
    Point<int>(inp.x ~/ div, inp.y ~/ div);
